    ...
    if kotoba == "のんびり🐢" and motimono in ["カメラ📸","スニーカー👟"] and kisetu in ["春🌸","秋🍂"]:
        ...
        with col2:
            st.markdown("""
                        ...
                        <p style="font-size:15px; font-weight:bold;">おすすめの季節</p>夏、冬
                        """, unsafe_allow_html=True)
        ...
        with col2:
            st.markdown("""
                        ...
                        ・自分だけの秘境を見つけたい<br><br>
                        <p style="font-size:15px; font-weight:bold;">おすすめの季節</p>夏、秋
                        """, unsafe_allow_html=True)
        ...
        with col2:
            st.markdown("""
                        ...
                        <p style="font-size:15px; font-weight:bold;">おすすめの季節</p>春、冬
                        """, unsafe_allow_html=True)
