...
kisetu = st.radio(st.subheader("旅行したい季節は？",["春🌸","夏🌳","秋🍂","冬⛄"]))
print(kisetu)

kotoba = st.radio(st.subheader("この中で一番惹かれる言葉は？",["神秘的","のんびり","ワイルド"]))
print(kotoba)

motimono = st.radio(st.subheader("この中で１つだけ持っていけるとしたら？",["カメラ","水着","スニーカー"]))
print(motimono)
