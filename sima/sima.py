...
if st.button("旅行先を診断する..."):
    if kotoba == "のんびり🐢" and motimono in ["カメラ📸","スニーカー👟"] and kisetu in ["春🌸","秋🍂"]:
        st.markdown('<h3>あなたにおすすめの島は…男木島(香川県)°•○☁️</h3>', unsafe_allow_html=True)
        ...
        st.markdown('<h3>あなたにおすすめの島は…与論島(鹿児島県)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1,2])
        with col1:
        ...
        st.markdown('<h3>あなたにおすすめの島は…久米島(沖縄県)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1,2])
        with col1:
        ...
        st.markdown('<h3>あなたにおすすめの島は…青ヶ島(東京都)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1,2])
        with col1:
        ...
        st.markdown('<h3>あなたにおすすめの島は…屋久島(鹿児島県)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1,2])
        with col1:
        ...
        st.markdown('<h3>あなたにおすすめの島は…与那国島(沖縄県)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1, 2])
        with col1:
        ...
        st.markdown('<h3>あなたにおすすめの島は…奥尻島(北海道)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1, 2])
        with col1:
        ...
        st.markdown('<h3>あなたにおすすめの島は…種子島(鹿児島県)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1, 2])
        with col1:
        ...
        st.markdown('<h3>あなたにおすすめの島は…礼文島(北海道)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1, 2])
        with col1:
        ...
        st.markdown('<h3>あなたにおすすめの島は…利尻島(北海道)°•○☁️</h3>', unsafe_allow_html=True)
        col1, col2 = st.columns([1, 2])
        with col1:
