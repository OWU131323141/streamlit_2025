...
kisetu =  st.subheader(st.radio("旅行したい季節は？",["春🌸","夏🌳","秋🍂","冬⛄"]))
print(kisetu)

kotoba =  st.subheader(st.radio("この中で一番惹かれる言葉は？",["神秘的","のんびり","ワイルド"]))
print(kotoba)

motimono =  st.subheader(st.radio("この中で１つだけ持っていけるとしたら？",["カメラ","水着","スニーカー"]))
print(motimono)
