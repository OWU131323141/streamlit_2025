...
if st.button("旅行先を診断する..."):
    if kotoba == "のんびり🐢" and motimono in ["カメラ📸","スニーカー👟"] and kisetu in ["春🌸","秋🍂"]:
        ...
        with col2:
            st.markdown("""
                        **どんな島？**<br>
                        樹齢数千年の杉と苔むす森、神秘的な自然の中で深呼吸できる島。<br>
                        **こんな人におすすめ！**<br>
                        ・もののけ姫の世界に浸りたい<br>
                        ・苔や巨樹などをカメラでじっくり撮影したい<br>
                        ・トレッキングやハイキングを楽しみたい<br>
                        **おすすめの季節**<br>春、秋
                        """, unsafe_allow_html=True)
        ...
        with col2:
            st.markdown("""
                        **どんな島？**<br>
                        日本最西端の地で、謎めいた海底遺跡と出会える神秘の島。<br>
                        **こんな人におすすめ！**<br>
                        ・ロマンあふれる海底遺跡に惹かれる<br>
                        ・非日常を味わえる秘境に行ってみたい<br>
                        ・歩いて回れる小さな島でのんびりしたい<br>
                        **おすすめの季節**<br>夏、秋
                        """, unsafe_allow_html=True)
        ...
        with col2:
            st.markdown("""
                        **どんな島？**<br>
                        ...
                        海の幸と自然を満喫できる、ちょっと特別な時間を味わえます。<br>
                        **こんな人におすすめ！**<br>
        ...
        with col2:
            st.markdown("""
                        **どんな島？**<br>
                        ...
                        海も山も満喫でき、カメラ片手に絶景を追いかけたくなるようなスポットが満載。<br>
                        **こんな人におすすめ！**<br>
                        ・ワイルドな自然の中でアクティブに過ごしたい<br>
                        ・ローカルな雰囲気を感じながら島の暮らしを見てみたい<br>
                        ・水着で海を満喫しつつ、カメラで風景も楽しみたい<br>
                        **おすすめの季節**<br>春、冬
                        """, unsafe_allow_html=True)
        ...
        with col2:
            st.markdown("""
                        **どんな島？**<br>
                        ...
                        島内には整備されたトレッキングコースがあり、スニーカーで自然の美しさをたっぷり味わえます。<br>
                        **こんな人におすすめ！**<br>
                        ・幻想的な風景や自然の神秘に惹かれる<br>
                        ・静かな時間の中で、花や風景を丁寧に味わいたい<br>
                        ・スニーカーで軽やかに島を歩き回りたい<br>
                        **おすすめの季節**<br>夏、秋
                        """, unsafe_allow_html=True)
        ...
        with col2:
            st.markdown("""
                        **どんな島？**<br>
                        ...
                        島の道は歩きやすく、スニーカーでのんびり散策にぴったりです。<br>
                        **こんな人におすすめ！**<br>
                        ・観光客が少ない場所で静かに過ごしたい<br>
                        ・自然の中でリラックスしながら景色を味わいたい<br>
                        ・スニーカーでのんびり歩きながら地元の雰囲気を感じたい<br>
                        **おすすめの季節**<br>夏、冬
                        """, unsafe_allow_html=True)
